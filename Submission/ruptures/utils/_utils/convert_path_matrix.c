...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "src/ruptures/utils/_utils"
        ],
        "name": "ruptures.utils._utils.convert_path_matrix",
        "sources": [
            "src/ruptures/utils/_utils/convert_path_matrix.pyx",
            "src/ruptures/utils/_utils/convert_path_matrix_c.c"
        ]
    },
    "module_name": "ruptures.utils._utils.convert_path_matrix"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ruptures__utils___utils__convert_path_matrix
#define __PYX_HAVE_API__ruptures__utils___utils__convert_path_matrix
/* Early includes */
#include "convert_path_matrix_c.h"
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
/* Module declarations from 'ruptures.utils._utils.convert_path_matrix' */
...
static PyObject *__pyx_f_8ruptures_5utils_6_utils_19convert_path_matrix_from_path_matrix_to_bkps_list(__Pyx_memviewslice, int, int, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "ruptures.utils._utils.convert_path_matrix"
extern int __pyx_module_is_main_ruptures__utils___utils__convert_path_matrix;
int __pyx_module_is_main_ruptures__utils___utils__convert_path_matrix = 0;

/* Implementation of 'ruptures.utils._utils.convert_path_matrix' */
...
static const char __pyx_k_n_bkps_max[] = "n_bkps_max";
...
static const char __pyx_k_path_matrix_flat[] = "path_matrix_flat";
...
static PyObject *__pyx_n_s_n_bkps_max;
...
static PyObject *__pyx_n_s_path_matrix_flat;
...
static PyObject *__pyx_pf_8ruptures_5utils_6_utils_19convert_path_matrix_from_path_matrix_to_bkps_list(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_path_matrix_flat, int __pyx_v_n_bkps, int __pyx_v_n_samples, int __pyx_v_n_bkps_max, int __pyx_v_jump); /* proto */
...
/* "ruptures/utils/_utils/convert_path_matrix.pyx":6
 * import numpy as np
 * 
...
static PyObject *__pyx_pw_8ruptures_5utils_6_utils_19convert_path_matrix_1from_path_matrix_to_bkps_list(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_8ruptures_5utils_6_utils_19convert_path_matrix_from_path_matrix_to_bkps_list(__Pyx_memviewslice __pyx_v_path_matrix_flat, int __pyx_v_n_bkps, int __pyx_v_n_samples, int __pyx_v_n_bkps_max, int __pyx_v_jump, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __Pyx_memviewslice __pyx_v_bkps_list = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("from_path_matrix_to_bkps_list", 0);

  /* "ruptures/utils/_utils/convert_path_matrix.pyx":8
 * cpdef from_path_matrix_to_bkps_list(int[:] path_matrix_flat, int n_bkps, int n_samples, int n_bkps_max, int jump):
 *     # Init bkps_list array
 *     cdef int[::1] bkps_list = np.empty((n_bkps+1), dtype=np.dtype("i"))             # <<<<<<<<<<<<<<
 *     try:
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_empty); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_long((__pyx_v_n_bkps + 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_dtype); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 8, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dc_int(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_bkps_list = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "ruptures/utils/_utils/convert_path_matrix.pyx":9
 *     # Init bkps_list array
 *     cdef int[::1] bkps_list = np.empty((n_bkps+1), dtype=np.dtype("i"))
 *     try:             # <<<<<<<<<<<<<<
 *         convert_pm.convert_path_matrix_c(&path_matrix_flat[0], n_bkps, n_samples, n_bkps_max, jump, &bkps_list[0])
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "ruptures/utils/_utils/convert_path_matrix.pyx":10
 *     cdef int[::1] bkps_list = np.empty((n_bkps+1), dtype=np.dtype("i"))
 *     try:
 *         convert_pm.convert_path_matrix_c(&path_matrix_flat[0], n_bkps, n_samples, n_bkps_max, jump, &bkps_list[0])             # <<<<<<<<<<<<<<
 *     except:
 ...
 */
      ...
      __pyx_t_12 = -1;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_v_path_matrix_flat.shape[0];
        if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_11 >= __pyx_v_path_matrix_flat.shape[0])) __pyx_t_12 = 0;
      ...
      __pyx_t_12 = -1;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_bkps_list.shape[0];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_bkps_list.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 10, __pyx_L3_error)
      }
      convert_path_matrix_c((&(*((int *) ( /* dim=0 */ (__pyx_v_path_matrix_flat.data + __pyx_t_11 * __pyx_v_path_matrix_flat.strides[0]) )))), __pyx_v_n_bkps, __pyx_v_n_samples, __pyx_v_n_bkps_max, __pyx_v_jump, (&(*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_bkps_list.data) + __pyx_t_13)) )))));
 ...
 */
    ...
    /* "ruptures/utils/_utils/convert_path_matrix.pyx":11
 *     try:
 *         convert_pm.convert_path_matrix_c(&path_matrix_flat[0], n_bkps, n_samples, n_bkps_max, jump, &bkps_list[0])
 *     except:             # <<<<<<<<<<<<<<
 *         print("An exception occurred.")
 ...
 */
    /*except:*/ {
      __Pyx_AddTraceback("ruptures.utils._utils.convert_path_matrix.from_path_matrix_to_bkps_list", __pyx_clineno, __pyx_lineno, __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_4, &__pyx_t_1, &__pyx_t_3) < 0) __PYX_ERR(0, 11, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_GOTREF(__pyx_t_3);

      /* "ruptures/utils/_utils/convert_path_matrix.pyx":12
 *         convert_pm.convert_path_matrix_c(&path_matrix_flat[0], n_bkps, n_samples, n_bkps_max, jump, &bkps_list[0])
 *     except:
 *         print("An exception occurred.")             # <<<<<<<<<<<<<<
 *     return np.asarray(bkps_list).tolist()
 */
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_print, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_XDECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  /* "ruptures/utils/_utils/convert_path_matrix.pyx":13
 *     except:
 *         print("An exception occurred.")
 *     return np.asarray(bkps_list).tolist()             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_asarray); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_bkps_list, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_tolist); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = NULL;
 ...
 */
  ...
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_bkps_list, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_8ruptures_5utils_6_utils_19convert_path_matrix_1from_path_matrix_to_bkps_list(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8ruptures_5utils_6_utils_19convert_path_matrix_1from_path_matrix_to_bkps_list(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_path_matrix_flat = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_n_bkps;
  int __pyx_v_n_samples;
  int __pyx_v_n_bkps_max;
  int __pyx_v_jump;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("from_path_matrix_to_bkps_list (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_path_matrix_flat,&__pyx_n_s_n_bkps,&__pyx_n_s_n_samples,&__pyx_n_s_n_bkps_max,&__pyx_n_s_jump,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_path_matrix_flat)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_bkps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("from_path_matrix_to_bkps_list", 1, 5, 5, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_samples)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("from_path_matrix_to_bkps_list", 1, 5, 5, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_bkps_max)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("from_path_matrix_to_bkps_list", 1, 5, 5, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_jump)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("from_path_matrix_to_bkps_list", 1, 5, 5, 4); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "from_path_matrix_to_bkps_list") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_path_matrix_flat = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_path_matrix_flat.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_n_bkps = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_n_bkps == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_n_samples = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_n_samples == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_n_bkps_max = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_n_bkps_max == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_jump = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_jump == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("from_path_matrix_to_bkps_list", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ruptures.utils._utils.convert_path_matrix.from_path_matrix_to_bkps_list", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8ruptures_5utils_6_utils_19convert_path_matrix_from_path_matrix_to_bkps_list(__pyx_self, __pyx_v_path_matrix_flat, __pyx_v_n_bkps, __pyx_v_n_samples, __pyx_v_n_bkps_max, __pyx_v_jump);
...
static PyObject *__pyx_pf_8ruptures_5utils_6_utils_19convert_path_matrix_from_path_matrix_to_bkps_list(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_path_matrix_flat, int __pyx_v_n_bkps, int __pyx_v_n_samples, int __pyx_v_n_bkps_max, int __pyx_v_jump) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("from_path_matrix_to_bkps_list", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_path_matrix_flat.memview)) { __Pyx_RaiseUnboundLocalError("path_matrix_flat"); __PYX_ERR(0, 6, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_8ruptures_5utils_6_utils_19convert_path_matrix_from_path_matrix_to_bkps_list(__pyx_v_path_matrix_flat, __pyx_v_n_bkps, __pyx_v_n_samples, __pyx_v_n_bkps_max, __pyx_v_jump, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "ruptures.utils._utils.convert_path_matrix.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "ruptures.utils._utils.convert_path_matrix.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "ruptures.utils._utils.convert_path_matrix.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "ruptures.utils._utils.convert_path_matrix._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"from_path_matrix_to_bkps_list", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8ruptures_5utils_6_utils_19convert_path_matrix_1from_path_matrix_to_bkps_list, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_convert_path_matrix(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_convert_path_matrix},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_n_bkps_max, __pyx_k_n_bkps_max, sizeof(__pyx_k_n_bkps_max), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_path_matrix_flat, __pyx_k_path_matrix_flat, sizeof(__pyx_k_path_matrix_flat), 0, 0, 1, 1},
 ...
 *     return np.asarray(bkps_list).tolist()
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_An_exception_occurred); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 12, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initconvert_path_matrix(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initconvert_path_matrix(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_convert_path_matrix(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_convert_path_matrix(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_convert_path_matrix(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'convert_path_matrix' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_convert_path_matrix(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("convert_path_matrix", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_ruptures__utils___utils__convert_path_matrix) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ruptures.utils._utils.convert_path_matrix")) {
      if (unlikely(PyDict_SetItemString(modules, "ruptures.utils._utils.convert_path_matrix", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "ruptures/utils/_utils/convert_path_matrix.pyx":4
 * 
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ruptures/utils/_utils/convert_path_matrix.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ruptures.utils._utils.convert_path_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ruptures.utils._utils.convert_path_matrix");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
